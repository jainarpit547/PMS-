...
const UserList = React.lazy(() => import('./views/components/User/UserList/User'));
const AddUser = React.lazy(() => import('./views/components/User/AddUser/AddUser'));
const AddProject = React.lazy(() => import('./views/components/Project/AddProject/AddProject'));
const UserDetail = React.lazy(() => import('./views/components/User/UserDetail/UserDetail'));
const ProjectList = React.lazy(() => import('./views/components/Project/ProjectList/Project'));
...
const TechnologyList = React.lazy(() => import('./views/components/Technology/TechnologyList/Technology'));
const AddTechnology = React.lazy(() => import('./views/components/Technology/AddTechnology/AddTechnology'));
...
const routes = [
     ...
     { path: '/technology-list', name: 'Technology List', component: TechnologyList },
     { path: '/add-technology', name: 'Add Technology', component: AddTechnology },
